(function(win, doc, $) {
	var oForm = doc.querySelector?doc.querySelector("form.elgg-form-kpax-image-upload"):
		$("form.elgg-form-kpax-image-upload")[0],
		...
		fpDrop = function(e) {
			...
			file = e.dataTransfer.files[0];
      		...
      		if(file && file.type.indexOf("image") !== -1) {
      			this.innerHTML = "<img src='/mod/kpax_theme_responsive/graphics/ajax-loader.gif' alt=''>";
	  			...
	  			reader.onload = function (event) {
					...
					xhr.open("POST", url.slice(0, url.indexOf("/kpax")) +"/action/kpax/image/upload");  
					xhr.send(formdata);
	...
	$("button.toggle").click(function(){
		$(this).toggleClass('open').find('.icon-arrow').toggleClass('open');
